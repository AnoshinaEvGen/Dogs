...
from Scripts.bloknot_1 import delete
...
# Создаем кнопку "Очистить вкладки"
ov_label = ttk.Label(window, text= 'Очистить вкладки')
ov_label.config(command=delete())
ov_label.pack(pady=10)
